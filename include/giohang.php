...
?>
<script src="./check_order_bill.js"></script>
				...
				<ul class="cart-list">
					<?php
						...
						while($row_get_cart_list_item = mysqli_fetch_array($sql_get_cart_list_item)){
							$total_price = $total_price + $row_get_cart_list_item['Gia'];
					?>
						<li class="cart-item">
							<div class="cart-item-left">
								<!-- <input class="cart-item-checkbox" type="checkbox" name=""> -->
								<div class="img-wrap">
									<img class="cart-item-img" src="./assets/img/<?php echo $row_get_cart_list_item['TenHinh'] ?>" alt="">
								</div>
