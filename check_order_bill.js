function order_bill(){
	...
	if(user_location_client){
		...
		var method = "GET";
		var url = "./add_bill.php?userLocation="+user_location_client+"&userPhone="+user_phone_client+"&userName="+user_Name_client+"&billStaff="+bill_staff+"&billTotal="+bill_total+"&orderDate="+Order_date+"&deliveryDate="+Delivery_date+"&billStatus="+bill_status;
