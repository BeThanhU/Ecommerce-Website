function add_product_cart(direct){
	...
	var method = "GET";
	var url = "./add.php?add=cart&userName="+user_Name_client+"&product_id="+cart_Product_id+"&product_name="+cart_Product_name+"&product_price="+cart_Product_price+"&product_amount="+cart_Product_amount+"&product_category="+cart_Product_category;
