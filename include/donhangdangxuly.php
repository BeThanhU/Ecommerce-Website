...
<div class="grid__column-10">
	<div class="my-profile-category">
		<span class="my-profile-category-label">Danh sách sản phẩm đã đặt</span>
	</div>
	<table class="manage-content-table">
		...
		<?php
			while($row_billprocessing = mysqli_fetch_array($sql_billprocessing)){
				if($row_billprocessing['TrangThaiDH']==4){
					$var_trangthai = "Chờ xác nhận";
				}elseif ($row_billprocessing['TrangThaiDH']==3) {
					$var_trangthai = "Đã xác nhận";
				}else{
					$var_trangthai = "Đang giao hàng";
				}
		?>
			<tr class="manage-content-list">
				...
				<td class="manage-content-list-item">
					<div class="table-cell-item">
						<img src="./assets/img/<?php echo $row_billprocessing['TenHinh'] ?>" alt="" class="table-cell-item-img">
