	...
	<div class="manage-content-wrap">
		<div class="grid__column-12">
			<table class="manage-content-table">
				...
				<?php
					$sql_user_bill = mysqli_query($con, 'select TaiKhoanKH, SoDonDH from dathang dh ORDER by dh.TrangThaiDH DESC, dh.NgayDH DESC');
				...
				?>
							<tr class="manage-content-list">
								...
								<td class="manage-content-list-item"><?php echo $row_info_bill['GiaTien'] ?></td>
								<td class="manage-content-list-item"><?php echo $row_info_bill['GiamGia'] ?></td>
								<td class="manage-content-list-item"><?php echo $row_info_bill['ThanhTien'] ?></td>
