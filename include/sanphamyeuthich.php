				...
				<div class="grid__column-2-4">
					<div class="home-product-item-wrap">
						<a href="?quanly=chitietsp&id=<?php echo $row_sanpham["MSHH"] ?>" class="home-product-item">
							<div class="home-product-item__img" style="background-image: url(./assets/img/<?php echo $row_img['TenHinh'] ?>);"></div>
						...
						<div class="home-product-item__action">
							<span id="home-product-item__like" class="home-product-item__like home-product-item__like--liked">
								<i onclick="itemLike(<?php echo $var_ID ?>)" class="home-product-item__like-icon far fa-heart"></i>
								<i onclick="itemLike(<?php echo $var_ID ?>)" class="home-product-item__liked-icon fas fa-heart"></i>
							</span>
