		...
		<nav class="header__navbar">
			<ul class="header__navbar-list">
				<li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
					...
					<!-- Header QR code -->
					<div class="header_qr">
						<img src="./assets/img/qrcode_4792960_.svg" alt="QR code" class="header__qr-img">

						<div class="header__qr-apps">
							<a href="" class="header__qr-link">
								<img src="./assets/img/google_play_icon.png" alt="Google Play" class="header__qr-download-img">
							</a>
							<a href="" class="header__qr-link">
								<img src="./assets/img/app_store_icon.png" alt="App Store" class="header__qr-download-img">
							</a>
			...
			<ul class="header__navbar-list">
				...
				<div class="header__navbar-user">
					<li class="header__navbar-item "> 
						<img src="./assets/img/avt.png" alt="" class="header__navbar-user-img">
						...
						<ul class="header__navbar-user-menu">
							...
							<li class="header__navbar-user-item header__navbar-user-item--separate">
								<a href="./test.php?status=logout">Đăng xuất</a>
							</li>
						</ul>
					</li>
				</div>
			...
			<div class="header__logo">
				<a href="test.php" class="header__logo-link">
					<p class="side-nav-logo">
						<span>BeU</span><img class="header__logo-img" src="assets/img/logo-ori-3-rmbg.jpg" alt="willfinchdesign">Store
					</p>
				</a>
			</div>
					...
					<div class="header__cart-list">
						...
						<ul class="header__cart-list-item">
							...
							<li class="header__cart-item">
								<img src="./assets/img/<?php echo $row_get_cart['TenHinh'] ?>" alt="" class="header__cart-img">
